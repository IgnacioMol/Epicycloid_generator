...
## RF7 — Presets (almacenar configuraciones con nombre) — *NO IMPLEMENTADO*
**Estado:** el componente [presets](src/app/features/presets/presets.ts) es un placeholder vacío y no está enrutado. **Nota:** existe export/import de patrones en JSON (RF6-adyacente), pero **no** son presets con nombre persistidos. Es el principal pendiente funcional.
